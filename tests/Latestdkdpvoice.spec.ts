...
const priceplan = [
  ...
  {
    id: testdata.priceplanid13,
    name: testdata.priceplanname13,
  },
];
...
const page1 = await page1Promise;
 ...
 //await page1.frameLocator('frame[name="leftFrame"]').locator('input[value="Voice"]').check();
  ...
  /// if the 6 m and 0 m values are correct then only proceed 
  if (devpricerw0.includes(pricezero) == true && devpricerw.includes(pricesix)==true)
  {
...
let option;
 ...
 for(let k=0;k<5;k++)
 {
     ...
     switch (k) {
                  case 0: 
                         option='MI4002';
                          console.log(ic10);//[0]+"-"+ic10[1]+"-"+ic10[2]+"-"+ic10[3]);
                         await function1.funct1(page1,ic10,option);                   

                 break;
                 case 1: 
                          option='MI4004';
                          console.log(ic20[0]+"-"+ic20[1]+"-"+ic20[2]+"-"+ic20[3]);
                         await function1.funct1(page1,ic20,option);                   

                 break;
                 case 3: 
                        option='MI4006';
                        console.log(ic30[0]+"-"+ic30[1]+"-"+ic30[2]+"-"+ic30[3]);
                        await function1.funct1(page1,ic30,option);                   

                 break;
                 case 4:
                        option='MI4013'; 
                        console.log(ic40[0]+"-"+ic40[1]+"-"+ic40[2]+"-"+ic40[3]);
                        await function1.funct1(page1,ic40,option);                   
...
{
  console.log("Test failed !!!!!!!!!Device price is not matching - please double check the oscar configuration")
}
